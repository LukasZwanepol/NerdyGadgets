...
<<<<<<< HEAD
                ...
                <div class="col-2 text-center">
                    ...
                    <div>
                        <p style="margin-left: -5%"> Subtotaal: <?php
        ...
        <?php if ($totalShoppingValue != 0) { ?>
            ...
            <?php foreach ($korting as $Kortingscode => $waarde) {
                ...
                if (isset($korting["KORTING"])) {
                    print ("margin-left: 73%; color:green");
        ...
        <?php if ($totalShoppingValue != 0) {
            print ("<p><a href='gegevens.php'><button style=\"background-color: #676EFF; font-size: large; border-radius: 12px;width: 150px; height: 40px; border: 1px rgba(35, 40, 47, 0.8); margin-left: 81%;\">Naar checkout</button></a></p>");
        }
        ?>
